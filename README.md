...
Если веб‑панель не нужна, при запуске установщика ответьте:
```
Install admin web panel? (y/N): n
```

В этом режиме установщик:
- пропустит ввод `ADMIN_WEB_USER`, `ADMIN_WEB_PASSWORD`, `ADMIN_WEB_SECRET`
- не создаст и не запустит сервис админ‑панели
