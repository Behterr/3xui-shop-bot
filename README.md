...
### Домен и SSL для веб‑панели

Если при установке включить веб‑панель и указать домен, установщик автоматически:
- установит Nginx + Certbot
- настроит прокси на `127.0.0.1:8000`
- выпустит SSL‑сертификат Let's Encrypt

Чтобы это сработало, перед запуском установщика:
1. Создайте A‑запись домена на IP вашего VPS
